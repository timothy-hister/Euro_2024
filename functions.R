...
#calc_points = function(round, score_1=NA, score_2=NA, prediction_1=NA, prediction_2=NA, winner=NA, pred_winner=NA, points_available) {
...
#   name = colDef(cell = function(value, index) if (round_2_ready) return(value) standings_tbl1())
...
scrape_scores = function() {
  new_scores = scrape_site("https://www.bbc.com/sport/football/european-championship/scores-fixtures/2024-07")
  old_scores = scrape_site("https://www.bbc.com/sport/football/european-championship/scores-fixtures/2024-07?filter=results")
